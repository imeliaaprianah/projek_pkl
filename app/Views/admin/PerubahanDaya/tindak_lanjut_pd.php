                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="/tindak-lanjut-pd/detail/<?= $a['id_data_pelanggan_pd'] ?>" class="btn btn-gradient-info btn-sm"><i class="fa fa-eye"></i> Detail</a>
                                        <a href="/tindak-lanjut-pd/edit/<?= $a['id_data_pelanggan_pd'] ?>" class="btn btn-gradient-warning btn-sm"><i class="fa fa-edit"></i> Edit</a>
                                        <a href="/tindak-lanjut-pd/delete/<?= $a['id_data_pelanggan_pd'] ?>" class="btn btn-gradient-danger btn-sm" onclick="return confirm('Apakah anda ingin menghapus data');"><i class="fa fa-trash"></i> Hapus</a>
                                    </td>
                                </tr>
                        <?php
                            }
