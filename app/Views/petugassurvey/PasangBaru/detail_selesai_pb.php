            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tanggal_survey" name="tanggal_survey" value="<?= $data['tanggal_survey'] ?>" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <a href="<?= base_url('uploads/' . $data['dokumen_pb']) ?>" target="_blank" class="btn btn-info btn-sm">
                                <i class="fa fa-download"></i> Lihat Surat
                            </a>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="<?= base_url('/selesai-pb-k') ?>" class="btn btn-secondary" style="padding: 10px 15px;">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
