            ...
            <div class="card-body">
                ...
                <form>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tanggal_survey" name="tanggal_survey" value="<?= $data['tanggal_survey']; ?>" placeholder="Tanggal Survey" readonly>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text"
                            class="form-control" id="status_approved" name="status_approved" value="<?= isset($data['status_approved']) ? $data['status_approved'] : 'pending'; ?>" readonly>
                        </input>
                    </div>


                    <div class="d-flex justify-content-end">
                        <a href="<?= base_url('/selesai-pd-m') ?>" class="btn btn-secondary" style="padding: 10px 15px;">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
