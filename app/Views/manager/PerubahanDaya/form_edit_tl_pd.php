    ...
    <div class="col-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?= site_url('tindak-lanjut-pd-m/update/' . $datpel['id_data_pelanggan_pd']) ?>" method="post" enctype="multipart/form-data">
                    <?= csrf_field() ?>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="tanggal_survey" name="tanggal_survey" value="<?= $datpel['tanggal_survey']; ?>" placeholder="Tanggal Survey">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div>
                            <a href="<?= base_url('uploads/' . $datpel['surat_mohon_perubahan_daya']) ?>" target="_blank" class="btn btn-info btn-sm">
                    ...
                    <div class="d-flex justify-content-end">
                        ...
                        <a href="<?= base_url('/tindak-lanjut-pd-m') ?>" class="btn btn-secondary" style="padding: 10px 15px;">Kembali</a>
                    </div>
                </form>
            </div>
        </div>
